    ...
    <div class="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
      ...
      <div>
        ...
        <div class="mt-2 flex space-x-2">
          <span class="px-2 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full">Angular 20</span>
          <span class="px-2 py-1 text-xs font-semibold bg-blue-100 text-blue-800 rounded-full">Tailwind CSS</span>
        </div>
      </div>
    </div>
  `
